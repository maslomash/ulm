...
\begin{document}
    ...
    \begin{enumerate}
        ...
        %     &= (n-1) - \sum_{j=1}^{n/2-2} \left( 2(n-2j)-1 \right) + \sum_{j=2}^{n/2-1} \left( 2(n-2j) -1 \right) \\
        %     &= (n-1) - \\
        %     &-\left(\sum_{j=1}^{n/2-1} ( 2(n-2j)-1) - (2(n-2(n/2-1)) -1) \right) + \\
        %     &+\left(\sum_{j=1}^{n/2-1} ( 2(n-2j)-1) - (2(n-2\cdot1)-1) \right) \\
        %     &= (n-1) + (2(n-2(n/2-1)) -1) - (2(n-2\cdot1)-1) \\
        %     &= (n-1) + (2(n-n+2)-1) - (2n-4-1) \\
        %     &= 7-n \neq 0
        % \end{align*}
    \end{enumerate}
