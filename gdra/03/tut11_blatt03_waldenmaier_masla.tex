...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{align*}
			...
			% &\stackrel{\text{P8}}{=} \overline{((\overline{x_1} + \overline{x_2}) (\overline{x_1} + \overline{x_2}))} \\
			% &\stackrel{\text{P4}}{=} \overline{(\overline{x_1} (\overline{x_1} + \overline{x_2}) + \overline{x_2}(\overline{x_1} + \overline{x_2}))} \\
			% &\stackrel{\text{P4}}{=} \overline{(\overline{x_1}\overline{x_1} + \overline{x_1}\overline{x_2} + \overline{x_2}\overline{x_1} + \overline{x_2}\overline{x_2})}\\
			% &\stackrel{\text{P1,P4}}{=} \overline{(\overline{x_1}\overline{x_1} + 2\cdot \overline{x_1}\overline{x_2} + \overline{x_2}\overline{x_2})}
		\end{align*}
		\item[c)]
		\begin{align*}
